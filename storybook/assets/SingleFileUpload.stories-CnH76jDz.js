import{j as t}from"./jsx-runtime-BO8uF4Og.js";import{r as U}from"./index-D4H_InIO.js";import{u as b,e as m,S as v,f as E,g as S,b as L,c as T,d as B,h,T as M,i as n,L as k,D as j,a as A}from"./MultiFileUpload-BYBlzUGG.js";import{S as u}from"./SingleFileUpload-D0UVjqO3.js";import{a as s}from"./DefaultPropsProvider-DyihzcVF.js";import"./index-BkuToD7M.js";import"./index-vYCkCKEW.js";const V={component:u,title:"SingleFileUpload",tags:["autodocs"],args:{failureRate:.1},argTypes:{uploadService:{table:{disable:!0}},onSuccessfulUpload:{table:{disable:!0}},fileManager:{table:{disable:!0}},body:{table:{disable:!0}},sx:{table:{disable:!0}}}},d={render:e=>{const r=b({failureRate:e.failureRate}),o=m();return t.jsx(v,{alignItems:"start",children:t.jsx(u,{disabled:e.disabled,acceptsOnly:e.acceptsOnly,uploadService:r,fileManager:o})})}},c={args:{title:"Custom Title Text",dropTitle:"Custom Drop Text",disabledTitle:"Custom Disabled Text",openFileSelectorTitle:"Custom Open File Browser"},render:e=>{const r=b({failureRate:e.failureRate}),o=m();return t.jsx(u,{disabled:e.disabled,sx:{dragZoneSx:()=>({borderStyle:"solid",borderWidth:1,borderRadius:0})},body:t.jsx(E,{title:e.title,dropTitle:e.dropTitle,disabledTitle:e.disabledTitle,openFileSelectorTitle:e.openFileSelectorTitle}),acceptsOnly:e.acceptsOnly,uploadService:r,fileManager:o})}},H=()=>{const{dropzoneState:e,openFileSelector:r}=B(),{disabled:o}=e,{status:l,isError:i}=U.useMemo(()=>h.getInfo(e),[e]);return t.jsxs(M,{paddingX:2,paddingY:1,color:i?"error":"inherit",minWidth:"400px",children:[l===n.overloaded&&"Custom Overloaded Body",l===n.dragRejected&&"Custom Drag Rejected",l===n.disabled&&"Custom Disabled",!i&&!o&&t.jsxs(t.Fragment,{children:[t.jsx(k,{onClick:r,children:"Custom Open File Browser"})," ",l===n.dragActive?"Custom Drop Text":"Custom Text Here"]})]})},p={render:e=>{const r=b({failureRate:e.failureRate}),o=m(),l=a=>({default:s(a.palette.secondary.main,T),disabled:s(a.palette.text.disabled,T),dragActive:s(a.palette.secondary.main,L)}),i=a=>({default:s(a.palette.secondary.main,A),disabled:s(a.palette.text.disabled,A),dragActive:s(a.palette.secondary.main,j)});return t.jsx(u,{disabled:e.disabled,body:t.jsx(H,{}),acceptsOnly:e.acceptsOnly,uploadService:r,fileManager:o,sx:{dragZoneSx:a=>g=>({backgroundColor:S.selectColor(a,l(g)),borderColor:S.selectColor(a,i(g))})}})}};var C,D,F;d.parameters={...d.parameters,docs:{...(C=d.parameters)==null?void 0:C.docs,source:{originalSource:`{
  render: args => {
