import{j as r}from"./jsx-runtime-QvZ8i92b.js";import{j as k,e as w,k as R,B as d,l as u,m as U,n as x,f as S}from"./MultiFileUpload-DJ2PQicy.js";import{r as j}from"./index-uubelm5h.js";const A=p=>{const{uploadService:m,acceptsOnly:y,onSuccessfulUpload:n,fileManager:g,body:f=r.jsx(S,{}),sx:e,disabled:c,statusFormatter:v}=p,{rejectedFiles:s,addRejected:b,removeRejected:F}=k(),{fileUploads:a,removeFileUpload:h,handlers:o}=g??w(),q=j.useMemo(()=>({onFileUploadStart:o.onFileUploadStart,onFileProgressUpdate:o.onFileProgressUpdate,onFileUploadComplete:t=>{n==null||n(t),o.onFileUploadComplete(t)}}),[o,n]),{upload:i}=R(m,q),l=s.length+a.length>0;return r.jsxs(d,{display:"flex",flexDirection:"column",children:[r.jsx(u,{appear:!1,unmountOnExit:!0,in:!l,timeout:{appear:0,enter:500,exit:200},children:r.jsx(d,{flexGrow:1,children:r.jsx(U,{disabled:c,sx:e==null?void 0:e.sx,allowsMultiple:!1,dragZoneSx:e!=null?e.dragZoneSx:()=>({borderRadius:"5px"}),dropZoneSx:e!=null?e.dropZoneSx:{borderRadius:"5px"},onFilesAccepted:i,onFilesRejected:b,acceptsOnly:y,children:f})})}),r.jsx(u,{in:l,style:{transitionDelay:"200ms"},children:r.jsx(x,{rejected:s,failed:a.failed,inProgress:a.inProgress,successful:n!=null?[]:a.successful,onRetry:i,onDismissRejected:F,onRemoveFileUpload:h,statusFormatter:v})})]})};A.__docgenInfo={description:"",methods:[],displayName:"SingleFileUpload",props:{uploadService:{required:!0,tsType:{name:"signature",type:"function",raw:`(
  file: File,
