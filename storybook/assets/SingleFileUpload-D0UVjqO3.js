import{j as r}from"./jsx-runtime-BO8uF4Og.js";import{f as k,j as w,e as R,k as U,B as d,l as u,m as x,n as S}from"./MultiFileUpload-BYBlzUGG.js";import{r as j}from"./index-D4H_InIO.js";const A=p=>{const{uploadService:m,acceptsOnly:y,onSuccessfulUpload:n,fileManager:g,body:f=r.jsx(k,{}),sx:e,disabled:c,statusFormatter:v}=p,{rejectedFiles:s,addRejected:b,removeRejected:F}=w(),{fileUploads:a,removeFileUpload:h,handlers:o}=g??R(),q=j.useMemo(()=>({onFileUploadStart:o.onFileUploadStart,onFileProgressUpdate:o.onFileProgressUpdate,onFileUploadComplete:t=>{n==null||n(t),o.onFileUploadComplete(t)}}),[o,n]),{upload:i}=U(m,q),l=s.length+a.length>0;return r.jsxs(d,{display:"flex",flexDirection:"column",children:[r.jsx(u,{appear:!1,unmountOnExit:!0,in:!l,timeout:{appear:0,enter:500,exit:200},children:r.jsx(d,{flexGrow:1,children:r.jsx(x,{disabled:c,sx:e==null?void 0:e.sx,allowsMultiple:!1,dragZoneSx:e!=null?e.dragZoneSx:()=>({borderRadius:"5px"}),dropZoneSx:e!=null?e.dropZoneSx:{borderRadius:"5px"},onFilesAccepted:i,onFilesRejected:b,acceptsOnly:y,children:f})})}),r.jsx(u,{in:l,style:{transitionDelay:"200ms"},children:r.jsx(S,{rejected:s,failed:a.failed,inProgress:a.inProgress,successful:n!=null?[]:a.successful,onRetry:i,onDismissRejected:F,onRemoveFileUpload:h,statusFormatter:v})})]})};A.__docgenInfo={description:"",methods:[],displayName:"SingleFileUpload",props:{uploadService:{required:!0,tsType:{name:"signature",type:"function",raw:`(
  file: File,
...
}`,signature:{properties:[{key:"id",value:{name:"string",required:!0}},{key:"file",value:{name:"File",required:!0}},{key:"progress",value:{name:"number",required:!0}},{key:"completed",value:{name:"boolean",required:!0}},{key:"failed",value:{name:"boolean",required:!1}},{key:"responseBody",value:{name:"Response",required:!1}}]}},name:"fileUpload"}],return:{name:"void"}}},description:"Called when a upload was successful. If this is provided then successful file uploads need to be rendered externally."},statusFormatter:{required:!1,tsType:{name:"signature",type:"function",raw:"(fileUpload: FileUpload<Response>) => string",signature:{arguments:[{type:{name:"signature",type:"object",raw:`{
  id: string;
  file: File;
  progress: number;
  completed: boolean;
  failed?: boolean;
  responseBody?: Response;
}`,signature:{properties:[{key:"id",value:{name:"string",required:!0}},{key:"file",value:{name:"File",required:!0}},{key:"progress",value:{name:"number",required:!0}},{key:"completed",value:{name:"boolean",required:!0}},{key:"failed",value:{name:"boolean",required:!1}},{key:"responseBody",value:{name:"Response",required:!1}}]}},name:"fileUpload"}],return:{name:"string"}}},description:`Returns a custom status label for a file upload e.g. "Uploading", "Failed" or "Completed".
@param fileUpload File upload for which the status should be formatted
@returns Status label for the file upload`},fileManager:{required:!1,tsType:{name:"signature",type:"object",raw:`{
  fileUploads: {
